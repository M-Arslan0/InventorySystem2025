  ...
  return (
    <div className="modal">
      <div
        ...
        style={{ maxWidth: "80%", margin: "0", padding: "0" }}
      >
        ...
        <form className="cards">
          <div className="card">
            <div className="w-[100%] flex justify-around">
              ...
              <select id="supplier" style={{ width: "25%" }}>
            ...
            <div className="data-entery min-h-[50vh]">
              <div className="data-entery-header">
                ...
                <select
                  name="proCode"
                  id="proCode"
                  style={{ width: "40%", margin: "5px", backgroundColor: "white" }}
                >
                ...
                <input
                  ...
                  name="qty"
                  placeholder="Qty"
                  style={{ width: "10%", margin: "5px", backgroundColor: "white" }}
                />
                <input
                  type="text"
                  name="price"
